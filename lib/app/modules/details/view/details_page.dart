  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Observer(
          builder: (_) {
            if(store.profilearray==null) return const Center(child: CircularProgressIndicator());
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Stack(children: [
                        CachedNetworkImage(
                          imageUrl:
                          'https://image.tmdb.org/t/p/w500${store.detailModel
                              ?.backdropPath}',
                          fit: BoxFit.fill,
                          height: MediaQuery
                              .of(context)
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (_, index) {
                            ...
                            return Padding(
                              ...
                              child:
                              ProfileTemplateWidget(profileModel: profile),
                            );
                          }),
                    ),
